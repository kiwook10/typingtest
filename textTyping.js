 ...
 function textTyping(){
    ...
    console.log("타이핑효과 정말 너무너무 잘되네")
    console.log("타이핑효과21112 잘되네")
    console.log("타이핑효과222 잘되네")
    console.log("타이핑효과3234 잘되네")
    console.log("타이핑효과234234 잘되네")
    console.log("타이핑효과 잘되네")
    console.log("타이핑효과234 잘되네")
    console.log("타이핑효과234 잘되네")
    console.log("타이핑효과 잘되네")
    console.log("타이핑효과234 잘되네")
    console.log("타이핑효과 잘되네")
    ...
    let subIndex = 0; // 배열에 있는 글자 데이터 순번값
    let backIndex = 0; //배열에 있는 글자 데이터의 한글자씩 가져오기 위한 순번값
    ...
    function typing(){
        ...
        //배열안에 있는 한단어씩 제거해서 출력
            ...
            if(maxIndex < 0){ //한문장의 글자제거가 전부 끝나면
                backIndex = 0;//다음 문장의 첫번째 글자서부터 출력을 하기위해 초기화
                //다음 순번의 문자열 출력을 위해 subIndex 숫자값 1증가
